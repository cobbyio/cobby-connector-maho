 ...
 */
class Cobby_Connector_Model_Export_Entity_Product extends Varien_Object
{
    /**
    ...
    public function filterChangedProducts($filterProducts)
    {
        ...
        $collection = Mage::getResourceModel('cobby_connector/product_collection')
    ...
    public function exportProducts($filterProductParams)
    {
        ...
        foreach ($this->_storeIdToCode as $storeId => $storeCode) {
            ...
            $collection = Mage::getResourceModel('cobby_connector/catalog_product_collection'); //$this->_prepareEntityCollection(
