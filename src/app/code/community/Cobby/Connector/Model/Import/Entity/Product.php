 ...
 */
class Cobby_Connector_Model_Import_Entity_Product extends Mage_ImportExport_Model_Import_Entity_Product
{
    ...
    {
        return array(
            'simple' => 'cobby_connector/import_entity_product_type_simple',
            'configurable' => 'cobby_connector/import_entity_product_type_configurable',
            'virtual' => 'cobby_connector/import_entity_product_type_simple',
            'grouped' => 'cobby_connector/import_entity_product_type_grouped',
            'bundle' => 'cobby_connector/import_entity_product_type_bundle'
        );
    }
    ...
    protected function _saveProducts()
    {
        ...
        if (!empty($productIds)) {
            ...
            Mage::helper('cobby_connector/queue')->enqueueAndNotify('product', 'save', $productIds, $this->getTransactionId());
        }
