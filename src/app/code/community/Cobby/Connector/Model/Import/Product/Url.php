...
class Cobby_Connector_Model_Import_Product_Url extends Cobby_Connector_Model_Import_Product_Abstract
{
    ...
    private function formatUrlKey($productId, $urlKey) {
        if ( !empty($urlKey) && $urlKey != Cobby_Connector_Model_Import_Entity_Product::COBBY_DEFAULT) {
    ...
    private function saveProductAttributes(array $attributesData)
    {
        ...
        foreach ($attributesData as $productId => $storeValues) {
            foreach ($storeValues as $storeId => $storeValue) {
                if ( $storeValue == Cobby_Connector_Model_Import_Entity_Product::COBBY_DEFAULT) {
